...
// htmlify(rawData)
      ...
      $.post("https://langcog.stanford.edu/cgi-bin/DisCon/speaker_change/discon.php",{expHTML: JSON.stringify(rawData)}, "json");

      return;
    }

    $.post("https://langcog.stanford.edu/cgi-bin/DisCon//speaker_chang/discon.php",{expHTML: JSON.stringify(rawData)}, "json");
