var preloadItems = ["car", "truck", "train", "bus", "airplane", "boat", "motorbike", "strawberry", "apple", "banana", "cherry", "orange", "melon", "pineapple", "dog", "cat", "horse", "bear", "cow", "monkey", "elephant", "bed", "chair", "table", "closet", "drawer", "sofa", "lamp", "stool", "shoe", "sock", "hat", "shirt", "jacket", "dress", "skirt", "drum", "flute", "guitar", "piano", "trumpet", "violin", "xylophone", "bread", "tv", "pencil"];
...
var speakerChange = shuffle(["change", "change", "change", "same", "same", "same"])
...
var posDist = shuffle([[6, 0, 0], [6, 0, 0], [6, 0, 0], [6, 0, 0], [6, 0, 0], [6, 0, 0]]);
...
var alternativeAgents = new Array();
for (var m=0; m < trials.length/2; m++) {
    alternativeAgents.push(posAgents[m+trials.length]);
}
...
var experiment = {
    ...
    introAll: function() {
        showSlide("introAll");
        document.getElementById("text_introAll").innerHTML = "You're visiting the house of these little animals. They will introduce you to the kinds of things they have at home. Your task is to click on the things they talk about. Pay close attention to the animals. Sometimes one animal goes away and a different animal returns.";
    ...
    train2 : function() {
        ...
        $(".item").click(function() {
            ...
            data = {
                experiment: "distribution_adults_speakerchange",
                trial: trials[0] + 1,
    ...
    speaker : function () {
        ...
        if (experiment.speakerChange[0] == "change"){
            ...
            setTimeout(function() {
                ...
                document.getElementById(alternativeAgents[0]+"_look_l").style.opacity="0";
                document.getElementById(alternativeAgents[0]+"_look_l").style.left="660px";
    ...
    transition: function() {
        ...
        if (experiment.speakerChange[0] == "change"){
            experiment.alternativeAgents.shift();
        };
