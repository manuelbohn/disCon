...
var experiment = {
    ...
    train2 : function() {
        ...
        document.getElementById("text_correctItem").innerHTML = "I like that. Can you click on the " + correctItem + "?";
        ...
        $(".item").click(function() {
            ...
            data = {
                experiment: "distribution_adults_speakerchange_oppside_preference",
                trial: trials[0] + 1,
    ...
    choice2 : function() {
        ...
        document.getElementById("text_correctItem").innerHTML = "I like that. Can you click on it?"
