...
waic <- brms::WAIC(bm1, bm2, compare = F)

weights <- model_weights(bm1, bm2)
...
data_frame(
  ...
  WAIC = c(waic$bm1$estimates[3,1],waic$bm2$estimates[3,1]),
  SE = c(waic$bm1$estimates[3,2],waic$bm2$estimates[3,2]),
