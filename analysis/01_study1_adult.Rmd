---
title: "DisCon Adult Study 1 (Absolute and Relative Strength of Inputs)"
...
write.csv(data_high, file="../data/01_study1_adult_high.data.csv")
data_high <- read_csv(file="../data/01_study1_adult_high.data.csv")
...
write.csv(data_high, file="../data/01_study1_adult_low.data.csv")
data_low <- read_csv(file="../data/01_study1_adult_low.data.csv")
