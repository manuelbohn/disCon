...
write.csv(data_pilot_another, file="../data/01_piot_summary_pilot_another.data.csv")
data_pilot_another <- read_csv(file="../data/01_piot_summary_pilot_another.data.csv")
...
write.csv(data_recency, file="../data/01_pilot_summary_recency.data.csv")
data_recency <- read_csv(file="../data/01_pilot_summary_recency.data.csv")
```
